...
@Component({
  selector: 'app-admin-azurira-profil-korisnika',
  templateUrl: './admin-azurira-profil-korisnika.component.html',
  styleUrls: ['./admin-azurira-profil-korisnika.component.css']
})
export class AdminAzuriraProfilKorisnikaComponent {
  constructor(private korisnikServis: KorisniciService, private router: Router){}


  ngOnInit():void{
    let x = localStorage.getItem("korisnikZaAzuriranje")
    if(x){
