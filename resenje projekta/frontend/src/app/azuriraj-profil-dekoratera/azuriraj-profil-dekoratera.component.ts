...
@Component({
  selector: 'app-azuriraj-profil-dekoratera',
  templateUrl: './azuriraj-profil-dekoratera.component.html',
  styleUrls: ['./azuriraj-profil-dekoratera.component.css']
})
export class AzurirajProfilDekorateraComponent {
